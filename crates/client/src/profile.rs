...
use chrono::DateTime;
use model::{
    DebugFormat, HostId, PeerIdentifier, ProfileId, QrPairingPayload, SshPairingPeer, SshTarget,
};
use tonic::transport::Channel;
use uuid::Uuid;

use crate::{
    ClientError, DeviceIdentity, PairingCandidate, PairingError, PairingStart, PeerEntry, PeerVia,
    PendingPeer, debug_format_to_wire, host_entry_from_wire, pairing_identity_from_wire,
