...
pub fn phase(model: &Model, agent: model::AgentId) -> ChatPhase {
...
/// honestly.
pub fn mode_cycle_gate(model: &Model, agent: model::AgentId) -> Option<&'static str> {
...
pub(super) fn answer_gate(model: &Model, agent: model::AgentId) -> Option<&'static str> {
    classify_model(model, agent, model.now()).answer_refusal()
}

pub(super) fn interrupt_gate(model: &Model, agent: model::AgentId) -> Option<&'static str> {
