...
use ui_state::attachments::ArtifactId;
use ui_state::review::{Review, RowRef, anchor, parse_patch};
use ui_state::{ArtifactKind, ArtifactRef, BaseIdentity, DiffBase, DiffFile, DiffResponse};
...
pub fn sample_review_element() -> String {
    ...
    ui_state::attachments::format_mention(&ui_state::attachments::Mention {
        kind: ui_state::attachments::MentionKind::Review {
