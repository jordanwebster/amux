...
use ui_state::DiffBase;
use ui_state::review::{Review, RowRef};
...
impl ReviewView {
    ...
    pub(super) fn files(&self) -> &[ui_state::review::ReviewFile] {
...
pub(super) fn file_line(
    file: &ui_state::review::ReviewFile,
    folded: bool,
    comments: usize,
    width: usize,
    theme: Theme,
...
#[cfg(test)]
mod tests {
    use ui_state::review::{Side, anchor};
