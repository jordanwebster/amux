...
//! facts however they arrive. Those facts live in `ui_state::claude::facts`;
...
use ui_state::claude::{AskDocument, QuestionFact, SuggestionFact, ToolInvocation};
use ui_state::claude_sdk::ElicitationForm;
