...
use ui_runtime::{RecorderSnapshot, Runtime};
...
mod frozen {
    ...
    use ui_runtime::{ConnectFailure, Connector, RuntimeOptions};
...
mod written {
    ...
    use ui_runtime::report::{PartState, ReportStatus, read_header};
    ...
    fn writer(dir: &std::path::Path) -> ui_runtime::report::ReportWriter {
        ui_runtime::report::ReportWriter::new(dir.to_path_buf(), ui_runtime::BUILD, "abc1234")
    }
