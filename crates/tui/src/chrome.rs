...
use ui_state::{AgentId, Command, HostId, Model, Msg, OpId};
...
pub enum TraceEvent {
    ...
    ProfilesListed {
        entries: Vec<ui_runtime::ProfileEntry>,
...
mod tests {
    ...
    fn chrome_for(state: crate::fixtures::NamedState) -> (ui_state::Model, Chrome) {
