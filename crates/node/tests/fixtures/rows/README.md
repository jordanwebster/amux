...
|---|---|---|
| `claude-pty/` | `crates/claude-specs/fixtures/pty/` | `claude_pty_transcript_v1` |
| `claude-sdk/` | `crates/claude-specs/fixtures/sdk/` | `claude_sdk_v1` |
| `codex/` | `crates/codex-specs/fixtures/runtime/` | `codex_sdk_v1` |

`crates/testnet/tests/derived_rows.rs` opens the provider recording, constructs
