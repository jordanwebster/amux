...
specs. Regenerate with `UPDATE_PROVIDER_COMMANDS=1 just test-crate testnet --
--test codex_provider_commands`; run all command proofs with
`just test -- provider_commands -- --nocapture`.
